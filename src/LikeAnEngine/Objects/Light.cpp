...
void Light::initValues(){
  ...
  _attC = 0.05; _attL = 0.05; _attQ = 0.0;
...
void Light::enableGLLight(int nLight){
  ...
  glLightf(_glLight, GL_CONSTANT_ATTENUATION, _attC);
  glLightf(_glLight, GL_LINEAR_ATTENUATION, _attL);
  glLightf(_glLight, GL_QUADRATIC_ATTENUATION, _attQ);
...
void Light::setAttenuationFacts(GLfloat c, GLfloat l, GLfloat q){
   _attC = c; _attL = l; _attQ = q;
}
