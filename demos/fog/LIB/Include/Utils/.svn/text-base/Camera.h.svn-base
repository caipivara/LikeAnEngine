...
class Camera{
 public:
  ...
  void setDeltaMoveCam(GLdouble deltaMoveCam);
  void setPos(GLdouble posX, GLdouble posY, GLdouble posZ);
  
  GLdouble* getLookAt();

  /*
    positiveBeta says if is a positive angleChange (true) or if it is negative(false), same for positiveTheta
  ...
  */
  ...
  void moveCamFront(bool toFront);

  //Move camera in the y coordinate
  void moveCamUp(bool up);
